...
export const reducer = (state = initialState, action) => {
  ...
  if (action.type === types.TOGGLE_LIKE) {
    return {...state, like: !state.inbox[action.payload].liked}
  }
  if (action.type === types.TOGGLE_BOOKMARK) {
    return {...state, bookmark: !state.inbox[action.payload].bookmark}
  }
  return state;
}
