...
const playlists = [
  ...
  {id: 4, name: 'Thursday', totalEpisodes: 3, totalTime: '120', isSelected: true},
...
const cancelSaveButton = (props) => {
  if (playlists.some(playlist => playlist.isSelected)) {
    return (
      <View style={styles.cancelSaveWrapper}>
        <TouchableOpacity onPress={props.handleAddToPlaylistModalClose} style={styles.cancelButton}>
          <Text style={styles.cancelSaveText}>Cancel</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={props.handleAddToPlaylistModalClose} style={styles.saveButton}>
      ...
      <View style={styles.container}>
        <ScrollView style={styles.scrollWrapper}>
          ...
          {playlists.map((playlist, index) => (
            <View style={playlistStyle(index)} key={index}>
